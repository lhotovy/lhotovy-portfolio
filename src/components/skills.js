...
export const Skills = () => {
  return (
    <div className="min-h-screen flex">
        <div className="flex-wrap inline-flex items-center justify-center gap-8 text-center sm:flex w-1/2 m-auto pt-8">
            {skillList.map((item) => 

            <div className=" bg-white rounded-lg drop-shadow-xl sm:w-2/3 md:w-1/3 lg:w-1/6 dark:bg-gray-800">
        ...
        <div className="pt-16 inline-flex w-1/4 flex-col m-auto ml-8">
